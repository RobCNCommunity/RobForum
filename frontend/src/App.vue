...
<template>
  ...
  <div v-else-if="publicRoute" class="rf-auth-shell"><div v-if="!loginRoute" class="rf-auth-brand"><RouterLink to="/"><img v-if="brandImage" :src="brandImage" :alt="siteName" /><span v-else class="rf-brand-mark">{{ brandInitial }}</span><strong>{{ siteName }}</strong></RouterLink></div><RouterView /></div>

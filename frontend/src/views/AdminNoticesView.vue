    ...
    <div class="admin-grid">
      <section class="pro-card">
        ...
        <form class="rf-editor-form" @submit.prevent="save">
          ...
          <div class="rf-form-actions"><nut-button type="primary" native-type="submit" :loading="saving" :disabled="mediaUploading">保存新闻</nut-button><button type="button" class="rf-secondary-button" @click="reset">清空</button></div>
        </form>
      </section>
